...
public class AbstractObjectList<T> implements Cloneable, Serializable {
	...
	/**
	 * Returns the index of the specified object, or -1 if the object is not in the
	 * list.
	 *
	...
	/**
	 * Clones the list of objects. The objects in the list are not cloned, so this
	 * is method makes a 'shallow' copy of the list.
	 *
	 * @return A clone.
	 * 
	 * @throws CloneNotSupportedException if an item in the list does not support
	 *                                    cloning.
	 */
	@Override
