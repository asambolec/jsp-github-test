...
public class RectangleConstraint {
	...
	public String toString() {
		return "RectangleConstraint[".concat(this.widthConstraintType.toString()).concat(": width=")
				.concat(String.valueOf(this.width)).concat(", height=").concat(String.valueOf(this.height)).concat("]");
	}
