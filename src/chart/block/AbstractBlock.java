...
public class AbstractBlock implements Cloneable, Serializable {
	...
	/**
	 * The natural width of the block (may be overridden if there are constraints in
	 * sizing).
	 */
	private double width;

	/**
	 * The natural height of the block (may be overridden if there are constraints
	 * in sizing).
	 */
