...
public interface Zoomable {
	 ...
	 * <code>source</code> point can be used in some cases to identify a subplot, or
	 * to determine the center of zooming (refer to the documentation of the
	 * implementing class for details).
	 *
	...
	/**
	 * Zooms in on the range axes. The <code>source</code> point can be used in some
	 * cases to identify a subplot for zooming.
	 *
	 * @param lowerPercent the new lower bound.
	 * @param upperPercent the new upper bound.
	 * @param state        the plot state.
