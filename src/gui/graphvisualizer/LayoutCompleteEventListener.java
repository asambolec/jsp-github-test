...
/**
 * This interface should be implemented by any class which needs to receive
 * LayoutCompleteEvents from the LayoutEngine. Typically this would be
 * implemented by the Visualization class.
 *
