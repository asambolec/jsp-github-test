...
/**
 * Support for PropertyEditors with custom editors: puts the editor into a
 * separate frame.
 *
...
public class PropertyDialog extends JDialog {
	...
	private Component mEditorComponent;
	...
	protected void initialize(PropertyEditor pe, int x, int y) {
		...
		mEditor = pe;
		mEditorComponent = pe.getCustomEditor();
		getContentPane().add(mEditorComponent, BorderLayout.CENTER);
