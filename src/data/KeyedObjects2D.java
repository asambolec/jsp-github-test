...
public class KeyedObjects2D implements Cloneable, Serializable {
	...
	/**
	 * Returns the row index for a given key, or <code>-1</code> if the key is not
	 * recognised.
	 *
	...
	/**
	 * Returns the column index for a given key, or <code>-1</code> if the key is
	 * not recognised.
	 *
	 * @param key the key (<code>null</code> not permitted).
	 *
	...
	/**
	 * Removes an object from the table by setting it to <code>null</code>. If all
	 * the objects in the specified row and/or column are now <code>null</code>, the
	 * row and/or column is removed from the table.
	 *
	 * @param rowKey    the row key (<code>null</code> not permitted).
	 * @param columnKey the column key (<code>null</code> not permitted).
	 *
	 ...
	 * @return A clone.
	 *
	 * @throws CloneNotSupportedException this class will not throw this exception,
